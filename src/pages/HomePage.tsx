    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
          <span className="block text-gray-900 dark:text-white">Your Pocket-Sized</span>
          <span className="block text-blue-600 dark:text-blue-500">eBay Scout</span>
        </h1>
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border-t-4 border-purple-500">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Get Price Drop Alerts</h3>
            <p className="text-gray-600 dark:text-gray-400">
              Save your searches and get notified when prices drop below your target. Never miss a deal again!
            </p>
          </div>
        </div>
      </div>
